...
namespace KasynoGui.Models
{
    ...
    {
        [Required]
        [StringLength(32, ErrorMessage = "{0} musi zawierać co najmniej następującą liczbę znaków: {2}.", MinimumLength = 2)]
        [Display(Name = "Imie")]
        public string Name { get; set; }

        [Required]
        [StringLength(48, ErrorMessage = "{0} musi zawierać co najmniej następującą liczbę znaków: {2}.", MinimumLength = 2)]
